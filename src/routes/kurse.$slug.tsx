...
export const Route = createFileRoute("/kurse/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      {
        name: "description",
        content: loaderData?.description ?? "Erste-Hilfe-Kurs bei der Pflaster Akademie.",
      },
        ...
        <div className="grid gap-12 lg:grid-cols-[1.6fr_1fr]">
          ...
          <div>
            ...
            >
              <motion.h2
                variants={fadeUp}
                className="text-2xl font-bold tracking-tight text-[var(--primary-deep)]"
              >
                Darum geht es
              </motion.h2>
              ...
              <motion.h3
                variants={fadeUp}
                className="mt-10 text-xl font-bold text-[var(--primary-deep)]"
              >
                Das lernst du
              </motion.h3>
            ...
            <figure className="mt-10 rounded-2xl border border-border bg-card p-7 shadow-[var(--shadow-card)]">
              ...
              <figcaption className="mt-4 text-sm font-semibold text-primary">
                — Teilnehmer der Pflaster Akademie
              </figcaption>
            </figure>
          </div>
          ...
          <div>
            ...
            <ul className="mt-6 space-y-2 text-sm text-foreground/90">
              <li className="flex items-start gap-2">
                <Check className="mt-0.5 h-4 w-4 text-primary" /> Unverbindliche Anfrage
              </li>
              <li className="flex items-start gap-2">
                <Check className="mt-0.5 h-4 w-4 text-primary" /> Persönliche Rückmeldung – kein Bot
              </li>
              <li className="flex items-start gap-2">
                <Check className="mt-0.5 h-4 w-4 text-primary" /> Auch Inhouse / Gruppentermine
                möglich
              </li>
            </ul>
          </div>
      ...
      <section className="bg-[var(--primary-deep)]">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6">
          ...
          <p className="mx-auto mt-3 max-w-xl text-primary-foreground/80">
            Wissen rettet Leben – wir zeigen dir wie. Melde dich jetzt an oder stelle uns deine
            Fragen.
          </p>
